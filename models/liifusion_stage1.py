...
class LIIF(nn.Module):
    ...
    def gen_feat(self, inp, ref):
        ...
        *_, h, w = ref.shape
        ...
        #prior = self.prior_encoder(torch.cat((ref, upsampled_inp), dim=1))
        prior = self.prior_encoder(torch.cat((upsampled_inp, upsampled_inp), dim=1))
        self.feat = self.prior_injector(feat, prior)
        return self.feat
