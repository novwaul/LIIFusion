...
class EDSR(nn.Module):
    def __init__(self, args, conv=default_conv, inc=None):
        ...
        if inc == None:
            ...
            m_head = [conv(inc, n_feats, kernel_size)]
...
def make_edsr_baseline(n_resblocks=16, n_feats=64, res_scale=1,
                       scale=2, no_upsampling=False, rgb_range=1, inc=None):
    args = Namespace()
